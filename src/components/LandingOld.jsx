        ...
        <div className=" w-[100%] md:w-[100%] mt-10 flex flex-col justify-center items-center text-lg  rounded-lg  mx-1 p-4 md:mx-8 box-border md:flex-row-reverse">
          ...
          <div className="w-[100%] md:w-[60%] flex flex-col items-center font-sans  ">
            ...
            <p className="text-base text-justify font-normal my-2 mx-0 md:mx-8 md:text-lg text-white">
              E-Cell Terna is a non-profit organization dedicated to uniting
              entrepreneurial passions on a common platform. Through prime
              events like B-Plan competitions, leadership lectures, case study
              workshops, and innovative games, it facilitates interaction among
              college students, corporations, and wokrking professionals from
              across Mumbai.
            </p>

            <div className="flex flex-row justify-start my-4 w-full ml-16">
              {/* <a href="" target="_blank">
                                <button className="text-sm bg-zinc-800 rounded-md px-4 py-2 text-white md:text-lg hover:bg-green transition ease-in-out  ">
                                    Learn More
                                </button>
                            </a> */}
            </div>
